   ...
   return (
      ...
      >
         ...
         >
            ...
            <div className={`absolute top-8 ${skills && skills[0].skill_index && '-left-1'}`}>
               {skills[0].skill_index ? (
                  ...
                  <div className="font-medium text-sm">설정된 기술 스택이 없습니다!</div>
               )}
            </div>
         </div>
         ...
         <div className={styles.info}>
            ...
            <div style={{ display: 'flex' }}>
               ...
               >
                  <img src="/public_assets/icons/show.svg" alt="아이콘" className="w-[17px] mr-2" />
                  <span>{views}</span>
               </div>
            </div>
         </div>
