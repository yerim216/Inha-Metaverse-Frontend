      ...
      <section className="w-full h-full hiddenScrollBar p-10 overflow-auto">
         ...
         >
            <button
               ...
               className={`flex-1 border-b-2 ${activated === 'project' && styles.boldFont}`}
               style={{
            ...
            <button
               ...
               className={`flex-1 border-b-2 ${activated === 'apply' && styles.boldFont}`}
               style={{
            ...
            <button
               ...
               className={`flex-1 border-b-2 ${activated === 'position' && styles.boldFont}`}
               style={{
