  ...
  return (
    <section className={styles.contain}>
      ...
      <div className={style.wrap}>
              ...
              {teamDetail &&
                (teamDetail.teamInfo.team_category[0].category_name === null ? (
                  <p
                    ...
                    style={{ color: tm.subTextColorDarker }}
                  >
                    {" "}
                    설정된 프로젝트 분야가 없어요
                  </p>
        ...
        >
          <Markdown
            children={teamDetail && teamDetail.teamInfo.team_description}
          />
        </div>
        <br></br>
        <br></br>
            ...
            teamDetail.teamInfo.team_jobs.map((recruitMem, index) => {
              return (
                ...
                >
                  ...
                  <div>
                    <p
                      className={styles.recruitMemNum}
        ...
        <div className={styles.memSearch}>
          <div
            className={`${
              themeMode === "light" ? styles.wrapp_light : styles.wrapp_dark
            }`}
          >
            {teamMembers &&
