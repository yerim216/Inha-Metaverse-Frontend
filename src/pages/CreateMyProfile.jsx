...
export default function CreateMyProfile() {
   ...
   const getField = () => {
      getUserInterested()
         .then(function (response) {
            ...
            const uniqueCategoriesObjects = uniqueCategories.map((category) => ({ field_category: category }));
   ...
   const handleCareerChange = () => {
      ...
      setDetailCareer((detailCareer) => [
         ...detailCareer,
         [{ job: job, syear: syear, smonth: smonth, eyear: eyear, emonth: emonth, dateDifference: dateDifference }],
      ]);
      setJob('');
            ...
            <div className={styles.topWrap}>
               <div className={styles.nameWrap}>
                  ...
                  <input
                     ...
                     style={{ background: tm.inputBg, color: tm.textColor, width: '80%' }}
                     value={userName}
               ...
               <div className={styles.nameWrap}>
                  ...
                  <select
                     className={styles.inputBox}
                     style={{ background: tm.inputBg, color: tm.textColor, width: '45%' }}
                     value={selectedField}
                  ...
                  <select
                     className={styles.inputBox}
                     style={{ background: tm.inputBg, color: tm.textColor, width: '35%' }}
                     value={selectedJob}
                  ...
                  <div className={styles.careerIn}>
                     ...
                     <div className={styles.dateSelect}>
                        <select
                           ...
                           style={{ width: '23%', background: tm.inputBg, color: tm.textColor }}
                        >
                           ...
                           <div className={styles.resultInner}>
                              <div className={styles.result} style={{ background: tm.inputBg, color: tm.textColor }}>
                                 ...
                                 <div className={styles.dateTxt}>
                                    ...
                                    <div className={styles.dateDiffer} style={{ background: tm.modifyBtn }}>
