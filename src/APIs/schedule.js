...
export function addScheduleByToDo({ team, title, content, status, start_date, end_date, writer, created_at, color }) {
   // console.log({
   //   team: team,
   //   title: title,
   //   content: content,
...
export function modifyEvent({ team, title, content, status, start_date, end_date, writer, last_update, color }) {
   // console.log({
   //   team: team,
   //   title: title,
   //   content: content,
